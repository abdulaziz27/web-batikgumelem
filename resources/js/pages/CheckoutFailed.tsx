                        ...
                        <CardContent>
                            ...
                            <div className="rounded-lg bg-gray-50 p-4">
                                ...
                                <p className="text-sm text-gray-600">
                                    Status: <span className="rounded-full bg-red-100 px-2 py-1 text-xs font-medium text-red-800">Gagal</span>
                                </p>
                            </div>

                            <div className="mt-6 text-center">
                                <p className="text-sm text-gray-600">Jika Anda mengalami masalah, silakan hubungi customer service kami di:</p>
