...
const Checkout = ({ cart, coupon, shippingOptions: initialShippingOptions, savedAddresses, auth }: CheckoutProps) => {
    console.log('Checkout Props di render:', {
        cart,
        coupon,
        initialShippingOptions,
        shippingOptionsLength: initialShippingOptions?.length,
    });
    ...
    // Use initialShippingOptions from props instead of state
    const [localShippingOptions, setLocalShippingOptions] = useState<ShippingOption[]>(initialShippingOptions || []);

    // Update localShippingOptions when initialShippingOptions changes
    useEffect(() => {
